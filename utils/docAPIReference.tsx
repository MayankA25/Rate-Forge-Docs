  ...
  window: 60_000,
    ...
    table: {
      ...
      tableBody: [
        ...
        [
          "TokenBucket",
          "store, capacity, refillRate"
        ],
        [
          "LeakyBucket",
          "store, capacity, leakRate"
        ],
        [
          "GCRA",
          "store and algorithm-specific configuration"
        ]
      ]
    }
  },
    ...
    table: {
      ...
      tableBody: [
        [
          "key",
          "string",
          "Unique key used to identify the stored value."
        ]
      ]
    }
  },
    ...
    table: {
      ...
      tableBody: [
        [
          "key",
          "string",
          "Key of the value that should be removed."
        ]
      ]
    }
  },

  {
    ...
    table: {
      ...
      tableBody: [
        [
          "MemoryStore",
          "Stores rate limiting state in application memory."
        ],
        [
          "RedisStore",
        ...
        [
          "MongoDBStore",
          "Uses MongoDB to store rate limiting state."
        ],
        [
          "PostgreSQLStore",
          "Uses PostgreSQL to store rate limiting state."
        ]
      ]
    }
  },
...
next();`
...

  {
    ...
    list: {
      intro: [
        "Common identifier strategies include:"
      ],
...

  {
    ...
    table: {
      ...
      tableBody: [
        ...
        [
          "IP Address",
          "Rate limiting unauthenticated clients."
        ],
        [
          "API Key",
        ...
        [
          "Session ID",
          "Rate limiting individual sessions."
        ],
        [
          "Client ID",
          "Rate limiting applications or clients."
        ],
        [
          "Custom Value",
          "Application-specific rate limiting requirements."
        ]
      ]
    }
  },
