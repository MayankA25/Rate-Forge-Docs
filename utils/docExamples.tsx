  ...
  (req, res) => {
    res.json({
...

      {
        ...
        table: {
          tableHeaders: ["Use Case", "Identifier"],
...
next();`,
...

      {
        ...
        list: {
          intro: ["Redis is a strong choice when:"],
...
next();`,
...

      {
        ...
        list: {
          intro: ["MongoDB can be a convenient choice when:"],
...
next();`,
...

      {
        ...
        list: {
          intro: ["PostgreSQL is useful when:"],
...
next();`,
...

      {
        ...
        table: {
          ...
          tableBody: [
            ...
            ["General API", "Token Bucket", "User ID", "100 requests"],
            [
              "Public API",
              "Sliding Window",
              "IP Address",
            ...
            ["Expensive Operations", "GCRA", "User ID", "Custom limit"],
          ],
        },
      },

      {
        ...
        list: {
          intro: ["Multiple limiters allow you to:"],
