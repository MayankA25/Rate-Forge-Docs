...
const limiter = new FixedWindow({
  ...
  window: 60_000,
    ...
    configurationTable: {
      ...
      tableBody: [
        ["store", "Memory Store instance passed to the rate limiting algorithm."]
      ]
    },
  ...
  window: 60_000,
    ...
    configurationTable: {
      ...
      tableBody: [
        ...
        ["store", "Redis Store instance passed to the rate limiting algorithm."]
      ]
    },
...
const limiter = new FixedWindow({
  ...
  window: 60_000,
    ...
    configurationTable: {
      tableHeaders: ["Option", "Description"],
      tableBody: [
        ["store", "MongoDB Store instance used as the rate limiting storage backend."]
      ]
    },
...
const limiter = new FixedWindow({
  ...
  window: 60_000,
    ...
    configurationTable: {
      tableHeaders: ["Option", "Description"],
      tableBody: [
        ["store", "PostgreSQL Store instance used as the rate limiting storage backend."]
      ]
    },
