export const advancedData = [
...

  {
    ...
    list: {
      intro: [
        "Consider the following when selecting a store:"
      ],
...
`,
    ...
    list: {
      intro: [
        "The request evaluation can be summarized as:"
      ],
...

  {
    ...
    list: {
      intro: [
        "Consider the following when evaluating Rate Forge performance:"
      ],
...
`,
    ...
    list: {
      intro: [
        "Concurrency becomes particularly important when:"
      ],
  ...
  contentBeforeCodes: [
    "This section answers common questions about configuring, integrating, and deploying Rate Forge."
  ],
