...
`,
  ...
  window: 60_000,
    ...
    configurationTable: {
      ...
      tableBody: [
        ["store", "Storage backend used to maintain rate limiting state."],
        [
          "limit",
...
RateLimit-Reset: 30`,
    ...
    configurationTable: {
      ...
      tableBody: [
        ["RateLimit-Limit", "Indicates the configured request limit."],
        ["RateLimit-Remaining", "Indicates the number of requests remaining."],
        [
          "RateLimit-Reset",
